...
const int wordPositions[][8] = {{5 , 84, 85, 86, 87, 88, 0 , 0 }, // 5 LEDs total, Position 0,1,2,3,4 in the string   => 0: ES IST
                                {4 , 80, 81, 82, 83, 0 , 0 , 0 }, // 4 LEDs total, Position 5,6,7,8 in the string     => 1: MFÜNF
                                {4 , 69, 70, 71, 72, 0 , 0 , 0 }, //                                                  => 2: MZEHN
                                {7 , 73, 74, 75, 76, 77, 78, 79}, //                                                  => 3: ZWANZIG
